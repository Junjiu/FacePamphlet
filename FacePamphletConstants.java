...
public interface FacePamphletConstants {
	...
	// the number of vertical pixels in the vertical margin of Friend title
	public static final double FRIEND_MARGIN=TOP_MARGIN+IMAGE_MARGIN;
	// the left pixels of Friend title
	public static final double LEFT_FRIEND=400;
